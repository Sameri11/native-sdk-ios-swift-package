...
let package = Package(
    ...
    targets: [
		.binaryTarget(
			name: "PlatformSDK",
			url: "https://maven.2gis.dev/ios-frameworks/0.9.7/Release/PlatformSDK.xcframework.zip",
			checksum: "434019cfc4a0a7cec6ea1fc96a073850c86e7206d1b28725608a9a5233c96fcd"
		),
		.binaryTarget(
			name: "PlatformMapSDK",
			url: "https://maven.2gis.dev/ios-frameworks/0.9.7/Release/PlatformMapSDK.xcframework.zip",
